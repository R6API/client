...
final class StatisticType extends AbstractEnum
{
    ...
    const OPERATORPVE_ATTACKERDRONE_DIMINISHEDREALITYMODE = 'operatorpve_attackerdrone_diminishedrealitymode';
    const OPERATORPVE_BANDIT_BATTERYKILL = "operatorpve_bandit_batterykill";
    const OPERATORPVE_BARRAGE_KILLSWITHTURRET = 'operatorpve_barrage_killswithturret';
    ...
    const OPERATORPVE_CALTROP_ENEMY_AFFECTED = 'operatorpve_caltrop_enemy_affected';
    ...
    const OPERATORPVE_CLASH_SLOWEDDOWN = 'operatorpve_clash_sloweddown';
    const OPERATORPVE_CONCUSSIONGRENADE_DETONATE = 'operatorpve_concussiongrenade_detonate';
    const OPERATORPVE_CONCUSSIONMINE_DETONATE = 'operatorpve_concussionmine_detonate';
    const OPERATORPVE_DAZZLER_GADGET_DETONATE = 'operatorpve_dazzler_gadget_detonate';
    const OPERATORPVE_DBNO = "operatorpve_dbno";
    const OPERATORPVE_DEATH = "operatorpve_death";
    const OPERATORPVE_DECEIVER_REVEALEDATTACKERS = 'operatorpve_deceiver_revealedattackers';
    ...
    const OPERATORPVE_MAVERICK_WALLBREACHED = 'operatorpve_maverick_wallbreached';
    ...
    const OPERATORPVE_PHONESHACKED = 'operatorpve_phoneshacked';
    ...
    const OPERATORPVE_RUSH_ADRENALINERUSH = 'operatorpve_rush_adrenalinerush';
    ...
    const OPERATORPVE_TAGGER_TAGDEVICE_SPOT = 'operatorpve_tagger_tagdevice_spot';
    ...
    const OPERATORPVP_ATTACKERDRONE_DIMINISHEDREALITYMODE = 'operatorpvp_attackerdrone_diminishedrealitymode';
    const OPERATORPVP_BANDIT_BATTERYKILL = "operatorpvp_bandit_batterykill";
    const OPERATORPVP_BARRAGE_KILLSWITHTURRET = 'operatorpvp_barrage_killswithturret';
    ...
    const OPERATORPVP_CALTROP_ENEMY_AFFECTED = 'operatorpvp_caltrop_enemy_affected';
    ...
    const OPERATORPVP_CLASH_SLOWEDDOWN = 'operatorpvp_clash_sloweddown';
    const OPERATORPVP_CONCUSSIONGRENADE_DETONATE = 'operatorpvp_concussiongrenade_detonate';
    const OPERATORPVP_CONCUSSIONMINE_DETONATE = 'operatorpvp_concussionmine_detonate';
    const OPERATORPVP_DAZZLER_GADGET_DETONATE = 'operatorpvp_dazzler_gadget_detonate';
    const OPERATORPVP_DBNO = "operatorpvp_dbno";
    const OPERATORPVP_DEATH = "operatorpvp_death";
    const OPERATORPVP_DECEIVER_REVEALEDATTACKERS = 'operatorpvp_deceiver_revealedattackers';
    ...
    const OPERATORPVP_MAVERICK_WALLBREACHED = 'operatorpvp_maverick_wallbreached';
    ...
    const OPERATORPVP_PHONESHACKED = 'operatorpvp_phoneshacked';
    ...
    const OPERATORPVP_RUSH_ADRENALINERUSH = 'operatorpvp_rush_adrenalinerush';
    ...
    const OPERATORPVP_TAGGER_TAGDEVICE_SPOT = 'operatorpvp_tagger_tagdevice_spot';
